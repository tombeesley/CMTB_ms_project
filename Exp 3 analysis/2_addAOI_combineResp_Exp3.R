...
cu_traits <- read_csv('Exp3_CU.csv') %>% 
  mutate(subj = str_c("P", ID - 200, "_Exp3")) %>%# make subj column compatible with the other dataframe
...
write_csv(finalData, "Exp_3_proc_data.csv")
